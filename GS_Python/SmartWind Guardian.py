#link: https://youtu.be/OZgUg6feE2E
...
while True:
    entrada = input("Velocidade do vento em km/h (ou 'sair'): ")
    ...
    if direcao_total > 100:
        print("Condição crítica: a mudança de direção do vento está acima de 100 graus. Tome cuidado!")
    else:
        print("Tudo certo por aqui :)")
